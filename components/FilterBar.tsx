    ...
    >
      <label className="min-w-0 flex-1 basis-full sm:basis-64">
        ...
        <input
          ...
          placeholder="Name, cuisine, neighborhood, or borough"
          className={`min-h-9 w-full rounded-md border border-ink/10 bg-white px-3 text-sm font-medium text-ink outline-none transition placeholder:text-ink/65 ${filterControlFocusClass}`}
        />
      </label>
