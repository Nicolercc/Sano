...
const auditedPairs = [
  ...
  ["ink/65 on oat", "#17201b", "#f6f2ea", 0.65],
  ["ink/65 on white", "#17201b", "#ffffff", 0.65],
  ["ink/65 on surface-2", "#17201b", "#fffaf1", 0.65],
  ["amberText on oat", "#7a4f08", "#f6f2ea", 1],
  ["amberText on white", "#7a4f08", "#ffffff", 1],
  ["coralText on oat", "#9f3f29", "#f6f2ea", 1],
  ["coralText on white", "#9f3f29", "#ffffff", 1]
];
...
const allowlistedTextPatterns = [
  {
    ...
    pattern: "placeholder:text-ink/40",
    reason: "placeholder hint, not persistent meaningful text"
  },
  {
    file: "components/SearchShell.tsx",
    pattern: "placeholder:text-white/40",
    reason: "placeholder hint, not persistent meaningful text"
  }
];
