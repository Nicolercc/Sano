...
3. Data strategy: real official NYC inspection data prepared into a stable seed first.
...
5. If Supabase is too risky, keep curated real-data seed and explain it clearly.
